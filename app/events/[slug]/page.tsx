//destrustire params and say they are og type promise that will be resolved with an object thats contains a key of slug of type string
...
const EventDetailsPage = async ({params}: {params:Promise<{slug:string}>})=>{
    ...
    if (!event) return notFound(); //404 from next
                ...
                {/* Right Side - Booking Form */}
                    <aside className="booking">
                        <div className="signup-card">
                            ...
                            {bookings>0?(
                                <p className="text-sm">
                                    Join {bookings} people have already booked their slot!
                                </p>
                            ):(
